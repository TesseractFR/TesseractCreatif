...
import onl.tesseract.creative.controller.command.argument.SpeedCommandArgument
...
@SpringComponent
class SpeedCommand(provider: CommandInstanceProvider) : CommandContext(provider) {
