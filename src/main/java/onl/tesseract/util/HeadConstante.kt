...
object HeadConstante {

    val teteApprenti = ItemBuilder(Material.PLAYER_HEAD).customHead(
    ...
    val teteConcepteur = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val teteCreateur = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val teteIngenieur = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val teteBatisseur = ItemBuilder(Material.PLAYER_HEAD).customHead(
    ...
    val tete100 = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val tete250 = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val tete500 = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val tete1000 = ItemBuilder(Material.PLAYER_HEAD).customHead(
        ...
        "")
    val teteEvent = ItemBuilder(Material.PLAYER_HEAD).customHead(
